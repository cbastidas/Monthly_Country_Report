...
#BRAND_VOLUME_SHEET_NAME = "brand_monthly_volume (Point10)"
KEYWORD_VOLUME_SHEET_NAME = "Historical_Search_Volume_Keywords"
...
def main():
   ...
   #process_csv_folder(CSV_FOLDER_PATH_BRANDS, BRAND_SHEET_NAME, "%Y-%m-%d")
    ...
    #process_csv_folder(CSV_FOLDER_PATH_BRAND_VOLUME, BRAND_VOLUME_SHEET_NAME, "%d/%m/%Y")
#
